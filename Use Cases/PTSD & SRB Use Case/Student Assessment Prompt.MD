...
1) Import patient clinical data, and create a binary PTSD diagnosis variable   
...
3) Now import the patient medication data. What is the dimensionality? How any rows are included and how many unique patients?   
